...
| `user-defined-workdir` | Currently we use a default working dir for everythin under /Users/jbencardino/ts, but we should have a workspace per repo and let the user configure where to set it up | requested | unknown |
