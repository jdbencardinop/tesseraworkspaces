# Implementation Record: push-branches
...
- `post-rebase-validation` — sha256=86b879708429... bytes=11974 files=7
...
```
 ...
 .tpatch/features/post-rebase-validation/status.json | 12 ++++++++----
...
git apply .tpatch/features/push-branches/artifacts/post-apply.patch
```
